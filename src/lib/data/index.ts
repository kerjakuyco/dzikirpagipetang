...
export const dzikirPagi: DzikirItem[] = [
  ...
  },
  {
    ...
    latin: "Qul huwallahu ahad, Allahu samad, lam yalid wa lam yulad, wa lam yakun lahu kufuwan ahad",
  ...
  },
  {
    ...
    latin: "Qul a'udzu bi rabbil falaq, min sharri ma khalaq, wa min sharri ghasiqin idha waqab, wa min sharrin naffathati fil 'uqad, wa min sharri hasidin idha hasad",
  ...
  },
  {
    ...
    latin: "Qul a'udzu bi rabbin nas, malikin nas, ilahin nas, min sharril waswasil khannas, alladzi yuwaswisu fi sudurin nas, minal jinnati wan nas",
